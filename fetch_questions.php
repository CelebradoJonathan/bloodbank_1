        ...
        $output .= "
              ...
              <tr>
                ...
                <td>
									...
									<input type = 'radio' name = 'answer_yn$intQuestionID' id = 'answer_yn$intQuestionID' value = 'Yes'>YES
									<input type = 'radio' name = 'answer_yn$intQuestionID' id = 'answer_yn$intQuestionID' value = 'No'>NO
								</td>
              </tr>
				...
				if($strQuestionType == 'Mixed')
				{
					$output .="
							...
							<tr>
								...
								<td>
									<input type = 'text' name = 'answer_text$intQuestionID'  id = 'answer_yn$intQuestionID'>
								</td>
							</tr>
...
echo "<button id = 'submit_answers'>Submit</button>";
echo $extra_js;
